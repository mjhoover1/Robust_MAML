...
def craftAttackUntargeted(mini_test, maml, images_to_patch_support, images_to_patch_query, applied_patch_target, mask_target, patch_target):
...
if __name__ == '__main__':
    ...
    success_rate = craftAttackUntargeted(mini_test, maml, images_to_patch_support, images_to_patch_query, applied_patch_target, mask_target, patch_target)
